...
public class AuthService {
    ...
    public String refresh(String refreshToken) {
        ...
        return jwtUtil.generateAccessToken(user.getId(), user.getEmail(), user.getRole().name(), null);
    }
    ...
    private AuthResponse buildAuthResponse(User user) {
        ...
        String accessToken = jwtUtil.generateAccessToken(user.getId(), user.getEmail(), user.getRole().name(), null);
